...
Нажмите на иконку администрирования image34.pngв правом верхнем углу экрана. На экране появится страница администрирования.
...
Нажмите иконку редактирования image21.png в правом нижнем углу карточки пользователя, чтобы изменить настройки. Используя выпадающее меню в окне Edit user data, выберите необходимые роли.
...
Нажмите на кнопку редактирования Edit user image21.png в правом нижнем углу карточки пользователя, чтобы изменить настройки.

Нажмите на иконку Change user password image27.png в правом нижнем углу карточки пользователя, чтобы изменить пароль пользователя.

Предусмотрена возможность поиска существующих пользователей системы с использованием кнопки Show filters image26.png, расположенной в правом верхнем углу. Чтобы найти пользователя или пользователей, нажмите эту кнопку и введите один из параметров для поиска пользователей в поле by login, first/last name, email.
...
Настройки фильтра сохраняются в системе между сессиями пользователя. Нажмите кнопку Reset filters image30.png в правом верхнем углу, чтобы сбросить все установленные фильтры.
...
Нажмите кнопку Add row image25.png справа внизу вкладки, чтобы сопоставить эти два выбранных элемента. Нажмите кнопку Update внизу, чтобы сохранить вновь сопоставленную пару.
...
Выберите пункт меню Users в консоли слева и отфильтруйте существующих пользователей с помощью кнопки Show filters image94.png в правом верхнем углу. Выберите пункт LDAP users в выпадающем меню with auth type.
...
В отличии от других LDAP пользователи имеют значок image91.png в правом верхнем углу карточки пользователя.
...
Нажмите кнопку редактирования image69.png на карточке команды. В появившейся странице с информацией о команде нажмите кнопку Actions image56.png. Чтобы добавить пользователя или пользователей в команду, в раскрывающемся меню выберите пункт Add user.
...
Чтобы удалить пользователя из команды, нажмите на значок Delete user from team image103.png в правом нижнем углу карточки пользователя.

image105.png

Изменение наименования команды
Нажмите кнопку редактирования image69.png на карточке команды. В появившейся странице с информацией о команде нажмите кнопку Actions image56.png. Чтобы переименовать команду, выберите пункт Edit team data в раскрывающемся меню.
