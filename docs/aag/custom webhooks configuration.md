...
После создания и конфигурации Custom webhook она может быть добавлена в Security Pipeline кодовой базы или артефакта. Более подробная информация приведена в разделе «[Security Pipelines](../../ug/security%20pipelines/#security-pipelines)» Руководства пользователя.
