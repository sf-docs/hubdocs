...
* Пункт **Task log** — позволяет просмотреть перечень и статус выполняемых на back-end задач для данного приложения (см. раздел «[Журнал задач](../application%20settings/#_8)»).
