...
* Пункт меню **DevSecOps** предназначен для работы с Security Pipelines (описание приведено в разделе «[Security Pipelines](../Security%20Pipelines/#security-pipelines)»).
