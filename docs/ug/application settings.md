...
Нажмите кнопку **Add group** справа и выберите команду из выпадающего меню, чтобы добавить команду в список команд, работающих с приложением. Чтобы удалить команду из этого списка, нажмите на значок "Х" справа от названия команды.
