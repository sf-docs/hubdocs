...
Справа от дефекта располагается кнопка **Action** ![](img/3dot.png), с помощью которой можно либо удалить дефект, либо разорвать связь (-и) с составляющими его проблемами безопасности.
